...
// New creates a new assetmodellock API client with basic auth credentials.
...
// New creates a new assetmodellock API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
func (a *Client) GetAssetModelLock(params *GetAssetModelLockParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAssetModelLockOK, error) {
	...
	if params == nil {
		params = NewGetAssetModelLockParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getAssetModelLock",
		Method:             "GET",
		PathPattern:        "/model/lock",
		ProducesMediaTypes: []string{"application/hal+json", "application/vnd.error+json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetAssetModelLockReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetAssetModelLockOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getAssetModelLock: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PutAssetModelLock(params *PutAssetModelLockParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PutAssetModelLockOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewPutAssetModelLockParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "putAssetModelLock",
		Method:             "PUT",
		PathPattern:        "/model/lock",
		ProducesMediaTypes: []string{"application/hal+json", "application/vnd.error+json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &PutAssetModelLockReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*PutAssetModelLockOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for putAssetModelLock: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
