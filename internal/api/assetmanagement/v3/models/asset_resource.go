...
type AssetResource struct {
	...
	// twin type
	// Enum: ["performance","simulation"]
	TwinType *string `json:"twinType,omitempty"`
}
...
func (m *AssetResource) validateFileAssignments(formats strfmt.Registry) error {
...
var assetResourceTypeTwinTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		assetResourceTypeTwinTypePropEnum = append(assetResourceTypeTwinTypePropEnum, v)
	}
}

// property enum
func (m *AssetResource) validateTwinTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, assetResourceTypeTwinTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *AssetResource) validateTwinType(formats strfmt.Registry) error {
	...
	// value enum
	if err := m.validateTwinTypeEnum("twinType", "body", *m.TwinType); err != nil {
		return err
	}
...
func (m *AssetResource) contextValidateFileAssignments(ctx context.Context, formats strfmt.Registry) error {
