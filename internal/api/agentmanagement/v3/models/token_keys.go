...
// Validate validates this token keys
func (m *TokenKeys) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TokenKeys) validateKeys(formats strfmt.Registry) error {
...
func (m *TokenKeys) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TokenKeys) contextValidateKeys(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TokenKeys) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TokenKeys) UnmarshalBinary(b []byte) error {
	var res TokenKeys
