...
// Validate validates this rotation keys
func (m *RotationKeys) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RotationKeys) validateJwks(formats strfmt.Registry) error {
...
func (m *RotationKeys) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RotationKeys) contextValidateJwks(ctx context.Context, formats strfmt.Registry) error {
