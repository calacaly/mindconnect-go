...
// Validate validates this paged agent
func (m *PagedAgent) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PagedAgent) validateContent(formats strfmt.Registry) error {
...
func (m *PagedAgent) validateFirst(formats strfmt.Registry) error {
...
func (m *PagedAgent) validateLast(formats strfmt.Registry) error {
...
func (m *PagedAgent) validateNumber(formats strfmt.Registry) error {
...
func (m *PagedAgent) validateNumberOfElements(formats strfmt.Registry) error {
...
func (m *PagedAgent) validateSize(formats strfmt.Registry) error {
...
func (m *PagedAgent) validateSort(formats strfmt.Registry) error {
...
func (m *PagedAgent) validateTotalElements(formats strfmt.Registry) error {
...
func (m *PagedAgent) validateTotalPages(formats strfmt.Registry) error {
...
func (m *PagedAgent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PagedAgent) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagedAgent) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
